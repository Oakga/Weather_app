    ...
    axios.get(apiCall,{
        ...
        for(let i=0;i<dailyDate.data.length;i++){
            ...
            const dayReport = weeklyReport[i] = {
                ...
                Day: day,
                Date: numDate,
                Summary: response.data.daily[i].summary,
                Humidity: response.data.daily[i].humidity,
                Precipitation: response.data.daily[i].precipProbability,
                Intensity: response.data.daily[i].precipIntensity,
                Wind: response.data.daily[i].windSpeed,
                MaxTemperature: response.data.daily[i].temperatureMax,
                MinTemperature: response.data.daily[i].temperatureMin,
            };
        };
