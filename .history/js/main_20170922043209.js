    ...
    axios.get(apiCall,{
        ...
        for(let i=0;i<dailyDate.data.length;i++){
            ...
            const dayReport = weeklyReport[i] = {
                ...
                Precipitation: response.data[i].precipProbability,
                Intensity: response.data[i].precipIntensity,
                Wind: response.data[i].windSpeed,
                MaxTemperature: response.data[i].temperatureMax,
                MinTemperature: response.data[i].temperatureMin,
            };
        };
