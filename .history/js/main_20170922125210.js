...
const darkSky = (lat, lng, date = Date.now()) => {
    // let apiCall = 'http://cors-anywhere.herokuapp.com/http://api.darksky.net/forecast/c84a2f187efcca194054935abae32b10/'+lat+','+lng;
    // axios.get(apiCall,{
    //     params: {
    ...
    $.ajax({
        url : "https://api.darksky.net/forecast/c84a2f187efcca194054935abae32b10/" + lng + ","+ lat + "+?exclude=minutely,hourly,daily,alerts,flags",
        dataType : "jsonp",
